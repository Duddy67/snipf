...
(function($) {
  ...
  $(window).load(function() {
    $('#jform_country_of_birth').change( function() { $.fn.setRegions(this.value); });
  ...
  $.fn.setRegions = function(country_code) {
    ...
    $('#jform_region_of_birth').empty();
    //Add the new region options to the select tag.
    $('#jform_region_of_birth').append(options);

    //Use Chosen jQuery plugin.
    $('#jform_region_of_birth').trigger('liszt:updated');
  };
  ...
  $.fn.initRegions = function() {
    ...
    if(regionCode != '') {
      ...
      $.fn.setRegions($('#jform_country_of_birth').val());
      //Set the region value previously selected. 
      $('#jform_region_of_birth').val(regionCode);
      $('#jform_region_of_birth').trigger('liszt:updated');
    }
  };
