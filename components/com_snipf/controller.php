...
class SnipfController extends JControllerLegacy
{
  ...
  public function __construct($config = array())
  {
    ...
    //Person frontpage Editor person proxying:
    if($this->input->get('view') === 'persons' && $this->input->get('layout') === 'modal') {
  ...
  public function display($cachable = false, $urlparams = false) 
  {
    ...
    // Person we are using p_id to avoid collisions with the router and the return page.
    ...
    // Check for edit form.
    if($vName == 'form' && !$this->checkEditId('com_snipf.edit.person', $id)) {
