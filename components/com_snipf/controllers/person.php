...
//Person: Override some parent form methods (libraries/legacy/controllers/form.php).
...
class SnipfControllerPerson extends JControllerForm
{
  ...
  {
    //Person: If a category id is found, check whether the user is allowed to create an item into this category.
    ...
    if($categoryId) {
      ...
      $allow = $user->authorise('core.create', 'com_snipf.category.'.$categoryId);
    }
  ...
  protected function allowEdit($data = array(), $key = 'id')
  {
    ...
    $user = JFactory::getUser();
    $userId = $user->get('id');
    $asset = 'com_snipf.person.'.$recordId;
